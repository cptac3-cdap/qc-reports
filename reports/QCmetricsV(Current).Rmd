...
<des class="description">
  <show>Show Section Details</show>
  <div class="text"><br>All values shown in session 2 are taken from the ‘numofMS2_ALL’ or ‘numofMS2_ID’ field from the metric file.<br>2.1: each point shows for a given analytical sample, the total MS/MS spectra by summing up all fractions.<br> 2.2 & 2.3: each point shows for each analytical sample’ fraction, the number of MS/MS spectra. X axis indicates the analytical sample ID, while y axis indicates the fraction ID.<br>2.4 & 2.5: identical to 2.2 & 2.3, each point shows the number of MS/MS spectra for each analytical sample’ fraction. X axis indicates the fraction ID, while y axis indicates the analytical sample ID.</div>
</des>
