...
p_pca_b2 <- ggplotly(p2, tooltip=c("colour")) %>% layout(annotations = pca_title, xaxis = x_per, yaxis = y_per, showlegend=TRUE , legend=list(orientation = "h", x = 0.18, y = -0.15, xanchor = "left", yanchor = "bottom"))
