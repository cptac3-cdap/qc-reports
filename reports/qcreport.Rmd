...
Graph shows box plot of the number of Distinct Peptide Counts across analytical sample vs. fractions. Each fraction is represented by a different color. 
...
g_MS2box_id <- gg_box(QCmetrics, y_string="PeptideCount", x_string="Fraction",
                      col_string="Fraction", label_string="`Fraction`")
p_MS2box_id <- ggplotly(g_MS2box_id, tooltip=c("label","label2")) %>% layout(annotations=peptide_title)
