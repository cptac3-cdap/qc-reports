...
QCmetrics$`Analytical sample` <- QCmetrics$analyticalBasenameLabel
...
## MS/MS Spectra for Fractions by Analytical Sample (box plot)
...
<!--
## MS/MS Spectra for Fractions by Analytical Sample (box plot, linked)
